...
![The list view of the Notes dialog](https://raw.githubusercontent.com/javierfurus/nfo/refs/heads/main/assets/notes-list.png "Notes: List view")

You can check at any time what the Agent has jotted down in the Notes popup. Browse the files and pick the one you are interested in.
...
- `bash` or `zsh`
- Linux or macOS (Windows via WSL only for now, untested)
